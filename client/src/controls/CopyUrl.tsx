import { Button, Field, Input, makeStyles, Popover, PopoverSurface, PopoverTrigger } from "@fluentui/react-components";
    ...
    return (
        ...
        >
            ...
            <div className={styles.buttonContainer}>
                <Popover withArrow >
                    <PopoverTrigger>
                        <Button appearance="primary" icon={<Copy16Filled />} onClick={() => {
