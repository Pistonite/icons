...
import { getFrameColorName, getFrameFillColor, getFrameOutlineColor, isFrameColorCustom, selectFrameColor, setCustomFrameFillColor, setCustomFrameOutlineColor, useStore } from "data/store.ts";
