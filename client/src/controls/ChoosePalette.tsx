...
import { Colors, type PaletteName, PaletteNames, Palettes } from "data/color.ts";
                    ...
                    >
                        {
                            ...
                            return (
                                <Option text={t(`palette.${name}`)} key={name} value={name}>
                                            ...
                                            <ColorCube color={Colors[palette.modifier].outline} />
