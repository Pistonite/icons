import { Body1, Button, Field, makeStyles, Popover, PopoverSurface, PopoverTrigger, useRestoreFocusTarget } from "@fluentui/react-components";
    ...
    return (
            <div className={styles.previewContainer}>
                ...
                <Field
                    label={t("ui.preview")}
                >
                    <div className={styles.iconContainer} style={{backgroundColor: previewBackground}}>
                ...
                >
                    <Popover withArrow trapFocus>
                        <PopoverTrigger disableButtonEnhancement>
                            <Button className={colorPickerStyles.button} {...restoreFocusAttributes}>
                ...
                <div className={colorPickerStyles.colorPickerContainer}>
                    <Field
                        label={t("ui.choose_preview_background")}
                    >
                        <HexColorPicker color={previewBackground} onChange={setPreviewBackground} />
                        <ColorInput color={previewBackground} setColor={setPreviewBackground} />
                    </Field>
                </div>
                        </PopoverSurface>
                    </Popover>
